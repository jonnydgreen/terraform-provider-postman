...
// checks if the UpdateEnvironmentRequestEnvironment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateEnvironmentRequestEnvironment{}

// UpdateEnvironmentRequestEnvironment struct for UpdateEnvironmentRequestEnvironment
type UpdateEnvironmentRequestEnvironment struct {
...
// NewUpdateEnvironmentRequestEnvironment instantiates a new UpdateEnvironmentRequestEnvironment object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUpdateEnvironmentRequestEnvironment(name string) *UpdateEnvironmentRequestEnvironment {
	this := UpdateEnvironmentRequestEnvironment{}
	this.Name = name
	return &this
}

// NewUpdateEnvironmentRequestEnvironmentWithDefaults instantiates a new UpdateEnvironmentRequestEnvironment object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUpdateEnvironmentRequestEnvironmentWithDefaults() *UpdateEnvironmentRequestEnvironment {
	this := UpdateEnvironmentRequestEnvironment{}
	return &this
}

// GetName returns the Name field value
func (o *UpdateEnvironmentRequestEnvironment) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *UpdateEnvironmentRequestEnvironment) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *UpdateEnvironmentRequestEnvironment) SetName(v string) {
	o.Name = v
}

// GetValues returns the Values field value if set, zero value otherwise.
func (o *UpdateEnvironmentRequestEnvironment) GetValues() [][]CreateEnvironmentRequestEnvironmentValuesInner {
...
// and a boolean to check if the value has been set.
func (o *UpdateEnvironmentRequestEnvironment) GetValuesOk() ([][]CreateEnvironmentRequestEnvironmentValuesInner, bool) {
	if o == nil || isNil(o.Values) {
		return nil, false
	}
...
func (o *UpdateEnvironmentRequestEnvironment) HasValues() bool {
	if o != nil && !isNil(o.Values) {
		return true
	}
...
func (o *UpdateEnvironmentRequestEnvironment) SetValues(v [][]CreateEnvironmentRequestEnvironmentValuesInner) {
	o.Values = v
}

func (o UpdateEnvironmentRequestEnvironment) MarshalJSON() ([]byte, error) {
...
func (o UpdateEnvironmentRequestEnvironment) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateEnvironmentRequestEnvironment struct {
	value *UpdateEnvironmentRequestEnvironment
	isSet bool
}

func (v NullableUpdateEnvironmentRequestEnvironment) Get() *UpdateEnvironmentRequestEnvironment {
	return v.value
}

func (v *NullableUpdateEnvironmentRequestEnvironment) Set(val *UpdateEnvironmentRequestEnvironment) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateEnvironmentRequestEnvironment) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateEnvironmentRequestEnvironment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateEnvironmentRequestEnvironment(val *UpdateEnvironmentRequestEnvironment) *NullableUpdateEnvironmentRequestEnvironment {
	return &NullableUpdateEnvironmentRequestEnvironment{value: val, isSet: true}
}

func (v NullableUpdateEnvironmentRequestEnvironment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateEnvironmentRequestEnvironment) UnmarshalJSON(src []byte) error {
	v.isSet = true
