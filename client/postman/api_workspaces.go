...
func (r ApiAllWorkspacesRequest) Type_(type_ string) ApiAllWorkspacesRequest {
	r.type_ = &type_
	return r
}

func (r ApiAllWorkspacesRequest) Execute() (*AllWorkspaces200Response, *http.Response, error) {
	return r.ApiService.AllWorkspacesExecute(r)
}
...
*/
func (a *WorkspacesApiService) AllWorkspaces(ctx context.Context) ApiAllWorkspacesRequest {
	return ApiAllWorkspacesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WorkspacesApiService) AllWorkspacesExecute(r ApiAllWorkspacesRequest) (*AllWorkspaces200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AllWorkspaces200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkspacesApiService.AllWorkspaces")
	if err != nil {
...
func (r ApiCreateWorkspaceRequest) Execute() (*CreateWorkspace200Response, *http.Response, error) {
...
func (a *WorkspacesApiService) CreateWorkspaceExecute(r ApiCreateWorkspaceRequest) (*CreateWorkspace200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateWorkspace200Response
	)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 404 {
			var v CreateWorkspace404Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r ApiDeleteWorkspaceRequest) Execute() (*DeleteWorkspace200Response, *http.Response, error) {
...
func (a *WorkspacesApiService) DeleteWorkspaceExecute(r ApiDeleteWorkspaceRequest) (*DeleteWorkspace200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DeleteWorkspace200Response
	)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 404 {
			var v UpdateWorkspace404Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r ApiSingleWorkspaceRequest) Execute() (*SingleWorkspace200Response, *http.Response, error) {
	return r.ApiService.SingleWorkspaceExecute(r)
}
...
func (a *WorkspacesApiService) SingleWorkspaceExecute(r ApiSingleWorkspaceRequest) (*SingleWorkspace200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SingleWorkspace200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkspacesApiService.SingleWorkspace")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateWorkspaceRequest) Execute() (*UpdateWorkspace200Response, *http.Response, error) {
...
func (a *WorkspacesApiService) UpdateWorkspaceExecute(r ApiUpdateWorkspaceRequest) (*UpdateWorkspace200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UpdateWorkspace200Response
	)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 403 {
			var v UpdateWorkspace403Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
