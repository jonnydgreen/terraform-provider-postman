...
// checks if the DeleteEnvironment200ResponseEnvironment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteEnvironment200ResponseEnvironment{}
...
// NewDeleteEnvironment200ResponseEnvironment instantiates a new DeleteEnvironment200ResponseEnvironment object
...
func NewDeleteEnvironment200ResponseEnvironment() *DeleteEnvironment200ResponseEnvironment {
	this := DeleteEnvironment200ResponseEnvironment{}
	return &this
}

// NewDeleteEnvironment200ResponseEnvironmentWithDefaults instantiates a new DeleteEnvironment200ResponseEnvironment object
...
func (o *DeleteEnvironment200ResponseEnvironment) SetId(v string) {
	o.Id = &v
}
...
func (o *DeleteEnvironment200ResponseEnvironment) SetUid(v string) {
	o.Uid = &v
}
...
type NullableDeleteEnvironment200ResponseEnvironment struct {
	value *DeleteEnvironment200ResponseEnvironment
	isSet bool
}

func (v NullableDeleteEnvironment200ResponseEnvironment) Get() *DeleteEnvironment200ResponseEnvironment {
	return v.value
}

func (v *NullableDeleteEnvironment200ResponseEnvironment) Set(val *DeleteEnvironment200ResponseEnvironment) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteEnvironment200ResponseEnvironment) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteEnvironment200ResponseEnvironment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteEnvironment200ResponseEnvironment(val *DeleteEnvironment200ResponseEnvironment) *NullableDeleteEnvironment200ResponseEnvironment {
	return &NullableDeleteEnvironment200ResponseEnvironment{value: val, isSet: true}
}

func (v NullableDeleteEnvironment200ResponseEnvironment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteEnvironment200ResponseEnvironment) UnmarshalJSON(src []byte) error {
	v.isSet = true
