...
// checks if the AllEnvironments404ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllEnvironments404ResponseError{}
...
// NewAllEnvironments404ResponseError instantiates a new AllEnvironments404ResponseError object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAllEnvironments404ResponseError() *AllEnvironments404ResponseError {
	this := AllEnvironments404ResponseError{}
	return &this
}

// NewAllEnvironments404ResponseErrorWithDefaults instantiates a new AllEnvironments404ResponseError object
...
func (o *AllEnvironments404ResponseError) GetName() string {
...
func (o *AllEnvironments404ResponseError) HasName() bool {
	if o != nil && !isNil(o.Name) {
		return true
	}
...
func (o *AllEnvironments404ResponseError) SetName(v string) {
	o.Name = &v
}
...
type NullableAllEnvironments404ResponseError struct {
	value *AllEnvironments404ResponseError
	isSet bool
}

func (v NullableAllEnvironments404ResponseError) Get() *AllEnvironments404ResponseError {
	return v.value
}

func (v *NullableAllEnvironments404ResponseError) Set(val *AllEnvironments404ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableAllEnvironments404ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableAllEnvironments404ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllEnvironments404ResponseError(val *AllEnvironments404ResponseError) *NullableAllEnvironments404ResponseError {
	return &NullableAllEnvironments404ResponseError{value: val, isSet: true}
}
