...
// checks if the UpdatePANFolder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePANFolder{}
...
// NewUpdatePANFolder instantiates a new UpdatePANFolder object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUpdatePANFolder() *UpdatePANFolder {
	this := UpdatePANFolder{}
	return &this
}

// NewUpdatePANFolderWithDefaults instantiates a new UpdatePANFolder object
...
type NullableUpdatePANFolder struct {
	value *UpdatePANFolder
	isSet bool
}

func (v NullableUpdatePANFolder) Get() *UpdatePANFolder {
	return v.value
}

func (v *NullableUpdatePANFolder) Set(val *UpdatePANFolder) {
	v.value = val
	v.isSet = true
}
...
func NewNullableUpdatePANFolder(val *UpdatePANFolder) *NullableUpdatePANFolder {
	return &NullableUpdatePANFolder{value: val, isSet: true}
}
