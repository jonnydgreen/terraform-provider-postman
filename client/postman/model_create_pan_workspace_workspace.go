...
// checks if the CreatePANWorkspaceWorkspace type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePANWorkspaceWorkspace{}
...
// NewCreatePANWorkspaceWorkspace instantiates a new CreatePANWorkspaceWorkspace object
...
func NewCreatePANWorkspaceWorkspace(id string, parentFolderId int32) *CreatePANWorkspaceWorkspace {
	this := CreatePANWorkspaceWorkspace{}
	this.Id = id
	this.ParentFolderId = parentFolderId
	return &this
}

// NewCreatePANWorkspaceWorkspaceWithDefaults instantiates a new CreatePANWorkspaceWorkspace object
...
func (o *CreatePANWorkspaceWorkspace) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
type NullableCreatePANWorkspaceWorkspace struct {
	value *CreatePANWorkspaceWorkspace
	isSet bool
}

func (v NullableCreatePANWorkspaceWorkspace) Get() *CreatePANWorkspaceWorkspace {
	return v.value
}

func (v *NullableCreatePANWorkspaceWorkspace) Set(val *CreatePANWorkspaceWorkspace) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePANWorkspaceWorkspace) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePANWorkspaceWorkspace) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePANWorkspaceWorkspace(val *CreatePANWorkspaceWorkspace) *NullableCreatePANWorkspaceWorkspace {
	return &NullableCreatePANWorkspaceWorkspace{value: val, isSet: true}
}
