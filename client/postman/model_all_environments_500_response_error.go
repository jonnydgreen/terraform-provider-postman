...
// checks if the AllEnvironments500ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllEnvironments500ResponseError{}
...
// NewAllEnvironments500ResponseError instantiates a new AllEnvironments500ResponseError object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAllEnvironments500ResponseError() *AllEnvironments500ResponseError {
	this := AllEnvironments500ResponseError{}
	return &this
}

// NewAllEnvironments500ResponseErrorWithDefaults instantiates a new AllEnvironments500ResponseError object
...
func (o *AllEnvironments500ResponseError) GetName() string {
...
func (o *AllEnvironments500ResponseError) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *AllEnvironments500ResponseError) SetName(v string) {
	o.Name = &v
}
...
type NullableAllEnvironments500ResponseError struct {
	value *AllEnvironments500ResponseError
	isSet bool
}

func (v NullableAllEnvironments500ResponseError) Get() *AllEnvironments500ResponseError {
	return v.value
}

func (v *NullableAllEnvironments500ResponseError) Set(val *AllEnvironments500ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableAllEnvironments500ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableAllEnvironments500ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllEnvironments500ResponseError(val *AllEnvironments500ResponseError) *NullableAllEnvironments500ResponseError {
	return &NullableAllEnvironments500ResponseError{value: val, isSet: true}
}
