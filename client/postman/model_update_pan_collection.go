...
// checks if the UpdatePANCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePANCollection{}
...
// NewUpdatePANCollection instantiates a new UpdatePANCollection object
...
// NewUpdatePANCollectionWithDefaults instantiates a new UpdatePANCollection object
...
func (o *UpdatePANCollection) GetCollection() UpdatePANCollectionCollection {
	if o == nil || isNil(o.Collection) {
		var ret UpdatePANCollectionCollection
		return ret
	}
	return *o.Collection
}
...
func (o *UpdatePANCollection) SetCollection(v UpdatePANCollectionCollection) {
	o.Collection = &v
}
...
type NullableUpdatePANCollection struct {
	value *UpdatePANCollection
	isSet bool
}

func (v NullableUpdatePANCollection) Get() *UpdatePANCollection {
	return v.value
}

func (v *NullableUpdatePANCollection) Set(val *UpdatePANCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdatePANCollection) IsSet() bool {
	return v.isSet
}
...
func NewNullableUpdatePANCollection(val *UpdatePANCollection) *NullableUpdatePANCollection {
	return &NullableUpdatePANCollection{value: val, isSet: true}
}
