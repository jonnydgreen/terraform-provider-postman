...
// checks if the UpdateEnvironment200ResponseEnvironment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateEnvironment200ResponseEnvironment{}
...
func NewUpdateEnvironment200ResponseEnvironment() *UpdateEnvironment200ResponseEnvironment {
	this := UpdateEnvironment200ResponseEnvironment{}
	return &this
}

// NewUpdateEnvironment200ResponseEnvironmentWithDefaults instantiates a new UpdateEnvironment200ResponseEnvironment object
...
func (o *UpdateEnvironment200ResponseEnvironment) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *UpdateEnvironment200ResponseEnvironment) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *UpdateEnvironment200ResponseEnvironment) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *UpdateEnvironment200ResponseEnvironment) SetId(v string) {
	o.Id = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *UpdateEnvironment200ResponseEnvironment) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateEnvironment200ResponseEnvironment) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *UpdateEnvironment200ResponseEnvironment) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *UpdateEnvironment200ResponseEnvironment) SetName(v string) {
	o.Name = &v
}

// GetUid returns the Uid field value if set, zero value otherwise.
func (o *UpdateEnvironment200ResponseEnvironment) GetUid() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateEnvironment200ResponseEnvironment) GetUidOk() (*string, bool) {
	if o == nil || IsNil(o.Uid) {
		return nil, false
	}
	return o.Uid, true
...
func (o *UpdateEnvironment200ResponseEnvironment) HasUid() bool {
	if o != nil && !IsNil(o.Uid) {
		return true
	}
...
func (o *UpdateEnvironment200ResponseEnvironment) SetUid(v string) {
	o.Uid = &v
}
...
type NullableUpdateEnvironment200ResponseEnvironment struct {
	value *UpdateEnvironment200ResponseEnvironment
	isSet bool
}

func (v NullableUpdateEnvironment200ResponseEnvironment) Get() *UpdateEnvironment200ResponseEnvironment {
	return v.value
}

func (v *NullableUpdateEnvironment200ResponseEnvironment) Set(val *UpdateEnvironment200ResponseEnvironment) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateEnvironment200ResponseEnvironment) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateEnvironment200ResponseEnvironment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateEnvironment200ResponseEnvironment(val *UpdateEnvironment200ResponseEnvironment) *NullableUpdateEnvironment200ResponseEnvironment {
	return &NullableUpdateEnvironment200ResponseEnvironment{value: val, isSet: true}
}

func (v NullableUpdateEnvironment200ResponseEnvironment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateEnvironment200ResponseEnvironment) UnmarshalJSON(src []byte) error {
	v.isSet = true
