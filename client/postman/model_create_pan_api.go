...
// checks if the CreatePANApi type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePANApi{}
...
// NewCreatePANApi instantiates a new CreatePANApi object
...
// NewCreatePANApiWithDefaults instantiates a new CreatePANApi object
...
func (v NullableCreatePANApi) Get() *CreatePANApi {
	return v.value
}
...
func NewNullableCreatePANApi(val *CreatePANApi) *NullableCreatePANApi {
	return &NullableCreatePANApi{value: val, isSet: true}
}
