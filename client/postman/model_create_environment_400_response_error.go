...
// checks if the CreateEnvironment400ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateEnvironment400ResponseError{}
...
// NewCreateEnvironment400ResponseError instantiates a new CreateEnvironment400ResponseError object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCreateEnvironment400ResponseError() *CreateEnvironment400ResponseError {
	this := CreateEnvironment400ResponseError{}
	return &this
}

// NewCreateEnvironment400ResponseErrorWithDefaults instantiates a new CreateEnvironment400ResponseError object
...
func (o *CreateEnvironment400ResponseError) SetName(v string) {
	o.Name = &v
}
...
type NullableCreateEnvironment400ResponseError struct {
	value *CreateEnvironment400ResponseError
	isSet bool
}

func (v NullableCreateEnvironment400ResponseError) Get() *CreateEnvironment400ResponseError {
	return v.value
}

func (v *NullableCreateEnvironment400ResponseError) Set(val *CreateEnvironment400ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateEnvironment400ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateEnvironment400ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateEnvironment400ResponseError(val *CreateEnvironment400ResponseError) *NullableCreateEnvironment400ResponseError {
	return &NullableCreateEnvironment400ResponseError{value: val, isSet: true}
}

func (v NullableCreateEnvironment400ResponseError) MarshalJSON() ([]byte, error) {
