...
// checks if the DeleteWorkspace200ResponseWorkspace type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteWorkspace200ResponseWorkspace{}
...
// NewDeleteWorkspace200ResponseWorkspace instantiates a new DeleteWorkspace200ResponseWorkspace object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDeleteWorkspace200ResponseWorkspace() *DeleteWorkspace200ResponseWorkspace {
	this := DeleteWorkspace200ResponseWorkspace{}
	return &this
}

// NewDeleteWorkspace200ResponseWorkspaceWithDefaults instantiates a new DeleteWorkspace200ResponseWorkspace object
...
func (o *DeleteWorkspace200ResponseWorkspace) SetId(v string) {
	o.Id = &v
}
...
type NullableDeleteWorkspace200ResponseWorkspace struct {
	value *DeleteWorkspace200ResponseWorkspace
	isSet bool
}

func (v NullableDeleteWorkspace200ResponseWorkspace) Get() *DeleteWorkspace200ResponseWorkspace {
	return v.value
}

func (v *NullableDeleteWorkspace200ResponseWorkspace) Set(val *DeleteWorkspace200ResponseWorkspace) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteWorkspace200ResponseWorkspace) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteWorkspace200ResponseWorkspace) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteWorkspace200ResponseWorkspace(val *DeleteWorkspace200ResponseWorkspace) *NullableDeleteWorkspace200ResponseWorkspace {
	return &NullableDeleteWorkspace200ResponseWorkspace{value: val, isSet: true}
}

func (v NullableDeleteWorkspace200ResponseWorkspace) MarshalJSON() ([]byte, error) {
