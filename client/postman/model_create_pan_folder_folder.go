...
// checks if the CreatePANFolderFolder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePANFolderFolder{}
...
// NewCreatePANFolderFolderWithDefaults instantiates a new CreatePANFolderFolder object
...
type NullableCreatePANFolderFolder struct {
	value *CreatePANFolderFolder
	isSet bool
}

func (v NullableCreatePANFolderFolder) Get() *CreatePANFolderFolder {
	return v.value
}

func (v *NullableCreatePANFolderFolder) Set(val *CreatePANFolderFolder) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePANFolderFolder) IsSet() bool {
	return v.isSet
}
...
func NewNullableCreatePANFolderFolder(val *CreatePANFolderFolder) *NullableCreatePANFolderFolder {
	return &NullableCreatePANFolderFolder{value: val, isSet: true}
}
