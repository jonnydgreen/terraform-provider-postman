...
// checks if the CreateWorkspace404ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateWorkspace404ResponseError{}
...
// NewCreateWorkspace404ResponseError instantiates a new CreateWorkspace404ResponseError object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCreateWorkspace404ResponseError() *CreateWorkspace404ResponseError {
	this := CreateWorkspace404ResponseError{}
	return &this
}

// NewCreateWorkspace404ResponseErrorWithDefaults instantiates a new CreateWorkspace404ResponseError object
...
func (o *CreateWorkspace404ResponseError) SetName(v string) {
	o.Name = &v
}
...
type NullableCreateWorkspace404ResponseError struct {
	value *CreateWorkspace404ResponseError
	isSet bool
}

func (v NullableCreateWorkspace404ResponseError) Get() *CreateWorkspace404ResponseError {
	return v.value
}

func (v *NullableCreateWorkspace404ResponseError) Set(val *CreateWorkspace404ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateWorkspace404ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateWorkspace404ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateWorkspace404ResponseError(val *CreateWorkspace404ResponseError) *NullableCreateWorkspace404ResponseError {
	return &NullableCreateWorkspace404ResponseError{value: val, isSet: true}
}
