...
// checks if the ScimGroupResourceMembers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScimGroupResourceMembers{}
...
// NewScimGroupResourceMembersWithDefaults instantiates a new ScimGroupResourceMembers object
...
type NullableScimGroupResourceMembers struct {
	value *ScimGroupResourceMembers
	isSet bool
}

func (v NullableScimGroupResourceMembers) Get() *ScimGroupResourceMembers {
	return v.value
}

func (v *NullableScimGroupResourceMembers) Set(val *ScimGroupResourceMembers) {
	v.value = val
	v.isSet = true
}

func (v NullableScimGroupResourceMembers) IsSet() bool {
	return v.isSet
}

func (v *NullableScimGroupResourceMembers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScimGroupResourceMembers(val *ScimGroupResourceMembers) *NullableScimGroupResourceMembers {
	return &NullableScimGroupResourceMembers{value: val, isSet: true}
}
