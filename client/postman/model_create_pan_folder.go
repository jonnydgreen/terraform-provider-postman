...
// checks if the CreatePANFolder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePANFolder{}
...
// NewCreatePANFolder instantiates a new CreatePANFolder object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCreatePANFolder() *CreatePANFolder {
	this := CreatePANFolder{}
	return &this
}

// NewCreatePANFolderWithDefaults instantiates a new CreatePANFolder object
...
type NullableCreatePANFolder struct {
	value *CreatePANFolder
	isSet bool
}

func (v NullableCreatePANFolder) Get() *CreatePANFolder {
	return v.value
}

func (v *NullableCreatePANFolder) Set(val *CreatePANFolder) {
	v.value = val
	v.isSet = true
}
...
func NewNullableCreatePANFolder(val *CreatePANFolder) *NullableCreatePANFolder {
	return &NullableCreatePANFolder{value: val, isSet: true}
}
