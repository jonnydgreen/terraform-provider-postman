...
// checks if the CreatePANCollectionCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePANCollectionCollection{}
...
func NewCreatePANCollectionCollection(id string, parentFolderId int32) *CreatePANCollectionCollection {
	this := CreatePANCollectionCollection{}
	this.Id = id
	this.ParentFolderId = parentFolderId
	return &this
}

// NewCreatePANCollectionCollectionWithDefaults instantiates a new CreatePANCollectionCollection object
...
func (o *CreatePANCollectionCollection) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CreatePANCollectionCollection) SetId(v string) {
	o.Id = v
}
...
type NullableCreatePANCollectionCollection struct {
	value *CreatePANCollectionCollection
	isSet bool
}

func (v NullableCreatePANCollectionCollection) Get() *CreatePANCollectionCollection {
	return v.value
}

func (v *NullableCreatePANCollectionCollection) Set(val *CreatePANCollectionCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePANCollectionCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePANCollectionCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePANCollectionCollection(val *CreatePANCollectionCollection) *NullableCreatePANCollectionCollection {
	return &NullableCreatePANCollectionCollection{value: val, isSet: true}
}
