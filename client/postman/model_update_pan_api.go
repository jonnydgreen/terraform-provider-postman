...
// checks if the UpdatePANApi type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePANApi{}
...
// NewUpdatePANApi instantiates a new UpdatePANApi object
...
// NewUpdatePANApiWithDefaults instantiates a new UpdatePANApi object
...
func (v NullableUpdatePANApi) Get() *UpdatePANApi {
	return v.value
}
...
func NewNullableUpdatePANApi(val *UpdatePANApi) *NullableUpdatePANApi {
	return &NullableUpdatePANApi{value: val, isSet: true}
}
