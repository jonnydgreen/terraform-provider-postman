...
// checks if the CreatePANApiApi type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePANApiApi{}
...
// NewCreatePANApiApi instantiates a new CreatePANApiApi object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCreatePANApiApi(id string, parentFolderId int32) *CreatePANApiApi {
	this := CreatePANApiApi{}
	this.Id = id
	this.ParentFolderId = parentFolderId
	return &this
}

// NewCreatePANApiApiWithDefaults instantiates a new CreatePANApiApi object
...
type NullableCreatePANApiApi struct {
	value *CreatePANApiApi
	isSet bool
}

func (v NullableCreatePANApiApi) Get() *CreatePANApiApi {
	return v.value
}

func (v *NullableCreatePANApiApi) Set(val *CreatePANApiApi) {
	v.value = val
	v.isSet = true
}
...
func NewNullableCreatePANApiApi(val *CreatePANApiApi) *NullableCreatePANApiApi {
	return &NullableCreatePANApiApi{value: val, isSet: true}
}
