...
// checks if the ScimUserResourceName type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScimUserResourceName{}
...
// NewScimUserResourceNameWithDefaults instantiates a new ScimUserResourceName object
...
type NullableScimUserResourceName struct {
	value *ScimUserResourceName
	isSet bool
}

func (v NullableScimUserResourceName) Get() *ScimUserResourceName {
	return v.value
}

func (v *NullableScimUserResourceName) Set(val *ScimUserResourceName) {
	v.value = val
	v.isSet = true
}

func (v NullableScimUserResourceName) IsSet() bool {
	return v.isSet
}
...
func NewNullableScimUserResourceName(val *ScimUserResourceName) *NullableScimUserResourceName {
	return &NullableScimUserResourceName{value: val, isSet: true}
}
