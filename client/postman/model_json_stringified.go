...
// checks if the JsonStringified type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JsonStringified{}
...
// NewJsonStringifiedWithDefaults instantiates a new JsonStringified object
...
func (v NullableJsonStringified) Get() *JsonStringified {
	return v.value
}

func (v *NullableJsonStringified) Set(val *JsonStringified) {
	v.value = val
	v.isSet = true
}
...
func NewNullableJsonStringified(val *JsonStringified) *NullableJsonStringified {
	return &NullableJsonStringified{value: val, isSet: true}
}
