...
// checks if the DeleteEnvironment200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteEnvironment200Response{}
...
// NewDeleteEnvironment200Response instantiates a new DeleteEnvironment200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDeleteEnvironment200Response() *DeleteEnvironment200Response {
	this := DeleteEnvironment200Response{}
	return &this
}

// NewDeleteEnvironment200ResponseWithDefaults instantiates a new DeleteEnvironment200Response object
...
func (o *DeleteEnvironment200Response) GetEnvironment() DeleteEnvironment200ResponseEnvironment {
	if o == nil || IsNil(o.Environment) {
		var ret DeleteEnvironment200ResponseEnvironment
		return ret
	}
...
func (o *DeleteEnvironment200Response) GetEnvironmentOk() (*DeleteEnvironment200ResponseEnvironment, bool) {
	if o == nil || IsNil(o.Environment) {
		return nil, false
	}
...
func (o *DeleteEnvironment200Response) SetEnvironment(v DeleteEnvironment200ResponseEnvironment) {
	o.Environment = &v
}
...
type NullableDeleteEnvironment200Response struct {
	value *DeleteEnvironment200Response
	isSet bool
}

func (v NullableDeleteEnvironment200Response) Get() *DeleteEnvironment200Response {
	return v.value
}

func (v *NullableDeleteEnvironment200Response) Set(val *DeleteEnvironment200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteEnvironment200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteEnvironment200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteEnvironment200Response(val *DeleteEnvironment200Response) *NullableDeleteEnvironment200Response {
	return &NullableDeleteEnvironment200Response{value: val, isSet: true}
}
