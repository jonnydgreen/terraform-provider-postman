...
// checks if the UpdatePANWorkspaceWorkspace type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePANWorkspaceWorkspace{}
...
func NewUpdatePANWorkspaceWorkspace() *UpdatePANWorkspaceWorkspace {
	this := UpdatePANWorkspaceWorkspace{}
	return &this
}

// NewUpdatePANWorkspaceWorkspaceWithDefaults instantiates a new UpdatePANWorkspaceWorkspace object
...
type NullableUpdatePANWorkspaceWorkspace struct {
	value *UpdatePANWorkspaceWorkspace
	isSet bool
}

func (v NullableUpdatePANWorkspaceWorkspace) Get() *UpdatePANWorkspaceWorkspace {
	return v.value
}

func (v *NullableUpdatePANWorkspaceWorkspace) Set(val *UpdatePANWorkspaceWorkspace) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdatePANWorkspaceWorkspace) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdatePANWorkspaceWorkspace) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdatePANWorkspaceWorkspace(val *UpdatePANWorkspaceWorkspace) *NullableUpdatePANWorkspaceWorkspace {
	return &NullableUpdatePANWorkspaceWorkspace{value: val, isSet: true}
}
