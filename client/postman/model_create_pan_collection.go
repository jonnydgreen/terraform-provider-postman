...
// checks if the CreatePANCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePANCollection{}
...
// NewCreatePANCollection instantiates a new CreatePANCollection object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCreatePANCollection() *CreatePANCollection {
	this := CreatePANCollection{}
	return &this
}

// NewCreatePANCollectionWithDefaults instantiates a new CreatePANCollection object
...
func (o *CreatePANCollection) SetCollection(v CreatePANCollectionCollection) {
	o.Collection = &v
}
...
type NullableCreatePANCollection struct {
	value *CreatePANCollection
	isSet bool
}

func (v NullableCreatePANCollection) Get() *CreatePANCollection {
	return v.value
}

func (v *NullableCreatePANCollection) Set(val *CreatePANCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePANCollection) IsSet() bool {
	return v.isSet
}
...
func NewNullableCreatePANCollection(val *CreatePANCollection) *NullableCreatePANCollection {
	return &NullableCreatePANCollection{value: val, isSet: true}
}
