...
type UpdateEnvironmentRequest struct {
	Environment *UpdateEnvironmentRequestEnvironment `json:"environment,omitempty"`
}
...
func (o *UpdateEnvironmentRequest) GetEnvironment() UpdateEnvironmentRequestEnvironment {
	if o == nil || isNil(o.Environment) {
		var ret UpdateEnvironmentRequestEnvironment
		return ret
	}
...
func (o *UpdateEnvironmentRequest) GetEnvironmentOk() (*UpdateEnvironmentRequestEnvironment, bool) {
	if o == nil || isNil(o.Environment) {
		return nil, false
	}
...
func (o *UpdateEnvironmentRequest) HasEnvironment() bool {
	if o != nil && !isNil(o.Environment) {
		return true
	}
...
// SetEnvironment gets a reference to the given UpdateEnvironmentRequestEnvironment and assigns it to the Environment field.
func (o *UpdateEnvironmentRequest) SetEnvironment(v UpdateEnvironmentRequestEnvironment) {
	o.Environment = &v
}
