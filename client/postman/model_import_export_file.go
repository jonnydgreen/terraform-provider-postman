...
// checks if the ImportExportFile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportExportFile{}
...
// NewImportExportFileWithDefaults instantiates a new ImportExportFile object
...
type NullableImportExportFile struct {
	value *ImportExportFile
	isSet bool
}

func (v NullableImportExportFile) Get() *ImportExportFile {
	return v.value
}

func (v *NullableImportExportFile) Set(val *ImportExportFile) {
	v.value = val
	v.isSet = true
}
...
func NewNullableImportExportFile(val *ImportExportFile) *NullableImportExportFile {
	return &NullableImportExportFile{value: val, isSet: true}
}
