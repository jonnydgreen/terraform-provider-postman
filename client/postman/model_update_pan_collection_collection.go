...
// checks if the UpdatePANCollectionCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePANCollectionCollection{}
...
// NewUpdatePANCollectionCollection instantiates a new UpdatePANCollectionCollection object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUpdatePANCollectionCollection() *UpdatePANCollectionCollection {
	this := UpdatePANCollectionCollection{}
	return &this
}

// NewUpdatePANCollectionCollectionWithDefaults instantiates a new UpdatePANCollectionCollection object
...
type NullableUpdatePANCollectionCollection struct {
	value *UpdatePANCollectionCollection
	isSet bool
}

func (v NullableUpdatePANCollectionCollection) Get() *UpdatePANCollectionCollection {
	return v.value
}

func (v *NullableUpdatePANCollectionCollection) Set(val *UpdatePANCollectionCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdatePANCollectionCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdatePANCollectionCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdatePANCollectionCollection(val *UpdatePANCollectionCollection) *NullableUpdatePANCollectionCollection {
	return &NullableUpdatePANCollectionCollection{value: val, isSet: true}
}
