...
// checks if the UpdatePANApiApi type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePANApiApi{}
...
func NewUpdatePANApiApi() *UpdatePANApiApi {
	this := UpdatePANApiApi{}
	return &this
}

// NewUpdatePANApiApiWithDefaults instantiates a new UpdatePANApiApi object
...
type NullableUpdatePANApiApi struct {
	value *UpdatePANApiApi
	isSet bool
}

func (v NullableUpdatePANApiApi) Get() *UpdatePANApiApi {
	return v.value
}

func (v *NullableUpdatePANApiApi) Set(val *UpdatePANApiApi) {
	v.value = val
	v.isSet = true
}
...
func NewNullableUpdatePANApiApi(val *UpdatePANApiApi) *NullableUpdatePANApiApi {
	return &NullableUpdatePANApiApi{value: val, isSet: true}
}
