...
// checks if the SingleWorkspace200ResponseWorkspaceCollectionsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SingleWorkspace200ResponseWorkspaceCollectionsInner{}
...
// NewSingleWorkspace200ResponseWorkspaceCollectionsInner instantiates a new SingleWorkspace200ResponseWorkspaceCollectionsInner object
...
func NewSingleWorkspace200ResponseWorkspaceCollectionsInner() *SingleWorkspace200ResponseWorkspaceCollectionsInner {
	this := SingleWorkspace200ResponseWorkspaceCollectionsInner{}
	return &this
}

// NewSingleWorkspace200ResponseWorkspaceCollectionsInnerWithDefaults instantiates a new SingleWorkspace200ResponseWorkspaceCollectionsInner object
...
func (o *SingleWorkspace200ResponseWorkspaceCollectionsInner) GetId() string {
	if o == nil || isNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *SingleWorkspace200ResponseWorkspaceCollectionsInner) GetIdOk() (*string, bool) {
	if o == nil || isNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *SingleWorkspace200ResponseWorkspaceCollectionsInner) HasId() bool {
	if o != nil && !isNil(o.Id) {
		return true
	}
...
func (o *SingleWorkspace200ResponseWorkspaceCollectionsInner) SetId(v string) {
	o.Id = &v
}

// GetName returns the Name field value if set, zero value otherwise.
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceCollectionsInner) GetName() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceCollectionsInner) GetNameOk() (*string, bool) {
	if o == nil || isNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *SingleWorkspace200ResponseWorkspaceCollectionsInner) HasName() bool {
	if o != nil && !isNil(o.Name) {
		return true
	}
...
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceCollectionsInner) SetName(v string) {
	o.Name = &v
}

// GetUid returns the Uid field value if set, zero value otherwise.
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceCollectionsInner) GetUid() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceCollectionsInner) GetUidOk() (*string, bool) {
	if o == nil || isNil(o.Uid) {
		return nil, false
	}
	return o.Uid, true
...
func (o *SingleWorkspace200ResponseWorkspaceCollectionsInner) HasUid() bool {
	if o != nil && !isNil(o.Uid) {
		return true
	}
...
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceCollectionsInner) SetUid(v string) {
	o.Uid = &v
}

func (o SingleWorkspace200ResponseWorkspaceCollectionsInner) MarshalJSON() ([]byte, error) {
...
func (o SingleWorkspace200ResponseWorkspaceCollectionsInner) ToMap() (map[string]interface{}, error) {
...
type NullableSingleWorkspace200ResponseWorkspaceCollectionsInner struct {
	value *SingleWorkspace200ResponseWorkspaceCollectionsInner
	isSet bool
}

func (v NullableSingleWorkspace200ResponseWorkspaceCollectionsInner) Get() *SingleWorkspace200ResponseWorkspaceCollectionsInner {
	return v.value
}

func (v *NullableSingleWorkspace200ResponseWorkspaceCollectionsInner) Set(val *SingleWorkspace200ResponseWorkspaceCollectionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSingleWorkspace200ResponseWorkspaceCollectionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSingleWorkspace200ResponseWorkspaceCollectionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSingleWorkspace200ResponseWorkspaceCollectionsInner(val *SingleWorkspace200ResponseWorkspaceCollectionsInner) *NullableSingleWorkspace200ResponseWorkspaceCollectionsInner {
	return &NullableSingleWorkspace200ResponseWorkspaceCollectionsInner{value: val, isSet: true}
}

func (v NullableSingleWorkspace200ResponseWorkspaceCollectionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSingleWorkspace200ResponseWorkspaceCollectionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
