...
// checks if the UpdateWorkspace200ResponseWorkspace type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateWorkspace200ResponseWorkspace{}
...
// NewUpdateWorkspace200ResponseWorkspace instantiates a new UpdateWorkspace200ResponseWorkspace object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUpdateWorkspace200ResponseWorkspace() *UpdateWorkspace200ResponseWorkspace {
	this := UpdateWorkspace200ResponseWorkspace{}
	return &this
}

// NewUpdateWorkspace200ResponseWorkspaceWithDefaults instantiates a new UpdateWorkspace200ResponseWorkspace object
...
func (o *UpdateWorkspace200ResponseWorkspace) GetId() string {
	if o == nil || isNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *UpdateWorkspace200ResponseWorkspace) GetIdOk() (*string, bool) {
	if o == nil || isNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *UpdateWorkspace200ResponseWorkspace) HasId() bool {
	if o != nil && !isNil(o.Id) {
		return true
	}
...
func (o *UpdateWorkspace200ResponseWorkspace) SetId(v string) {
	o.Id = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *UpdateWorkspace200ResponseWorkspace) GetName() string {
...
func (o *UpdateWorkspace200ResponseWorkspace) HasName() bool {
	if o != nil && !isNil(o.Name) {
		return true
	}
...
func (o *UpdateWorkspace200ResponseWorkspace) SetName(v string) {
	o.Name = &v
}
...
type NullableUpdateWorkspace200ResponseWorkspace struct {
	value *UpdateWorkspace200ResponseWorkspace
	isSet bool
}

func (v NullableUpdateWorkspace200ResponseWorkspace) Get() *UpdateWorkspace200ResponseWorkspace {
	return v.value
}

func (v *NullableUpdateWorkspace200ResponseWorkspace) Set(val *UpdateWorkspace200ResponseWorkspace) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateWorkspace200ResponseWorkspace) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateWorkspace200ResponseWorkspace) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateWorkspace200ResponseWorkspace(val *UpdateWorkspace200ResponseWorkspace) *NullableUpdateWorkspace200ResponseWorkspace {
	return &NullableUpdateWorkspace200ResponseWorkspace{value: val, isSet: true}
}

func (v NullableUpdateWorkspace200ResponseWorkspace) MarshalJSON() ([]byte, error) {
