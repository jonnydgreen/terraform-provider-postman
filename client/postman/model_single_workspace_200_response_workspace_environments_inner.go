...
// checks if the SingleWorkspace200ResponseWorkspaceEnvironmentsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SingleWorkspace200ResponseWorkspaceEnvironmentsInner{}
...
// NewSingleWorkspace200ResponseWorkspaceEnvironmentsInner instantiates a new SingleWorkspace200ResponseWorkspaceEnvironmentsInner object
...
func NewSingleWorkspace200ResponseWorkspaceEnvironmentsInner() *SingleWorkspace200ResponseWorkspaceEnvironmentsInner {
	this := SingleWorkspace200ResponseWorkspaceEnvironmentsInner{}
	return &this
}

// NewSingleWorkspace200ResponseWorkspaceEnvironmentsInnerWithDefaults instantiates a new SingleWorkspace200ResponseWorkspaceEnvironmentsInner object
...
func (o *SingleWorkspace200ResponseWorkspaceEnvironmentsInner) GetId() string {
	if o == nil || isNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *SingleWorkspace200ResponseWorkspaceEnvironmentsInner) GetIdOk() (*string, bool) {
	if o == nil || isNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *SingleWorkspace200ResponseWorkspaceEnvironmentsInner) HasId() bool {
	if o != nil && !isNil(o.Id) {
		return true
	}
...
func (o *SingleWorkspace200ResponseWorkspaceEnvironmentsInner) SetId(v string) {
	o.Id = &v
}

// GetName returns the Name field value if set, zero value otherwise.
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceEnvironmentsInner) GetName() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceEnvironmentsInner) GetNameOk() (*string, bool) {
	if o == nil || isNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *SingleWorkspace200ResponseWorkspaceEnvironmentsInner) HasName() bool {
	if o != nil && !isNil(o.Name) {
		return true
	}
...
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceEnvironmentsInner) SetName(v string) {
	o.Name = &v
}

// GetUid returns the Uid field value if set, zero value otherwise.
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceEnvironmentsInner) GetUid() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceEnvironmentsInner) GetUidOk() (*string, bool) {
	if o == nil || isNil(o.Uid) {
		return nil, false
	}
	return o.Uid, true
...
func (o *SingleWorkspace200ResponseWorkspaceEnvironmentsInner) HasUid() bool {
	if o != nil && !isNil(o.Uid) {
		return true
	}
...
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceEnvironmentsInner) SetUid(v string) {
	o.Uid = &v
}

func (o SingleWorkspace200ResponseWorkspaceEnvironmentsInner) MarshalJSON() ([]byte, error) {
...
func (o SingleWorkspace200ResponseWorkspaceEnvironmentsInner) ToMap() (map[string]interface{}, error) {
...
type NullableSingleWorkspace200ResponseWorkspaceEnvironmentsInner struct {
	value *SingleWorkspace200ResponseWorkspaceEnvironmentsInner
	isSet bool
}

func (v NullableSingleWorkspace200ResponseWorkspaceEnvironmentsInner) Get() *SingleWorkspace200ResponseWorkspaceEnvironmentsInner {
	return v.value
}

func (v *NullableSingleWorkspace200ResponseWorkspaceEnvironmentsInner) Set(val *SingleWorkspace200ResponseWorkspaceEnvironmentsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSingleWorkspace200ResponseWorkspaceEnvironmentsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSingleWorkspace200ResponseWorkspaceEnvironmentsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSingleWorkspace200ResponseWorkspaceEnvironmentsInner(val *SingleWorkspace200ResponseWorkspaceEnvironmentsInner) *NullableSingleWorkspace200ResponseWorkspaceEnvironmentsInner {
	return &NullableSingleWorkspace200ResponseWorkspaceEnvironmentsInner{value: val, isSet: true}
}

func (v NullableSingleWorkspace200ResponseWorkspaceEnvironmentsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSingleWorkspace200ResponseWorkspaceEnvironmentsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
