...
// checks if the UpdateWorkspace400ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateWorkspace400ResponseError{}
...
// NewUpdateWorkspace400ResponseError instantiates a new UpdateWorkspace400ResponseError object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUpdateWorkspace400ResponseError() *UpdateWorkspace400ResponseError {
	this := UpdateWorkspace400ResponseError{}
	return &this
}

// NewUpdateWorkspace400ResponseErrorWithDefaults instantiates a new UpdateWorkspace400ResponseError object
...
func (o *UpdateWorkspace400ResponseError) GetName() string {
...
func (o *UpdateWorkspace400ResponseError) HasName() bool {
	if o != nil && !isNil(o.Name) {
		return true
	}
...
func (o *UpdateWorkspace400ResponseError) SetName(v string) {
	o.Name = &v
}
...
type NullableUpdateWorkspace400ResponseError struct {
	value *UpdateWorkspace400ResponseError
	isSet bool
}

func (v NullableUpdateWorkspace400ResponseError) Get() *UpdateWorkspace400ResponseError {
	return v.value
}

func (v *NullableUpdateWorkspace400ResponseError) Set(val *UpdateWorkspace400ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateWorkspace400ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateWorkspace400ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateWorkspace400ResponseError(val *UpdateWorkspace400ResponseError) *NullableUpdateWorkspace400ResponseError {
	return &NullableUpdateWorkspace400ResponseError{value: val, isSet: true}
}
