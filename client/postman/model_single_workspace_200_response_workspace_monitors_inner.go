...
// checks if the SingleWorkspace200ResponseWorkspaceMonitorsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SingleWorkspace200ResponseWorkspaceMonitorsInner{}
...
// NewSingleWorkspace200ResponseWorkspaceMonitorsInner instantiates a new SingleWorkspace200ResponseWorkspaceMonitorsInner object
...
func NewSingleWorkspace200ResponseWorkspaceMonitorsInner() *SingleWorkspace200ResponseWorkspaceMonitorsInner {
	this := SingleWorkspace200ResponseWorkspaceMonitorsInner{}
	return &this
}

// NewSingleWorkspace200ResponseWorkspaceMonitorsInnerWithDefaults instantiates a new SingleWorkspace200ResponseWorkspaceMonitorsInner object
...
func (o *SingleWorkspace200ResponseWorkspaceMonitorsInner) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *SingleWorkspace200ResponseWorkspaceMonitorsInner) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *SingleWorkspace200ResponseWorkspaceMonitorsInner) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *SingleWorkspace200ResponseWorkspaceMonitorsInner) SetId(v string) {
	o.Id = &v
}

// GetName returns the Name field value if set, zero value otherwise.
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceMonitorsInner) GetName() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceMonitorsInner) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *SingleWorkspace200ResponseWorkspaceMonitorsInner) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceMonitorsInner) SetName(v string) {
	o.Name = &v
}

// GetUid returns the Uid field value if set, zero value otherwise.
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceMonitorsInner) GetUid() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceMonitorsInner) GetUidOk() (*string, bool) {
	if o == nil || IsNil(o.Uid) {
		return nil, false
	}
	return o.Uid, true
...
func (o *SingleWorkspace200ResponseWorkspaceMonitorsInner) HasUid() bool {
	if o != nil && !IsNil(o.Uid) {
		return true
	}
...
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceMonitorsInner) SetUid(v string) {
	o.Uid = &v
}

func (o SingleWorkspace200ResponseWorkspaceMonitorsInner) MarshalJSON() ([]byte, error) {
...
type NullableSingleWorkspace200ResponseWorkspaceMonitorsInner struct {
	value *SingleWorkspace200ResponseWorkspaceMonitorsInner
	isSet bool
}

func (v NullableSingleWorkspace200ResponseWorkspaceMonitorsInner) Get() *SingleWorkspace200ResponseWorkspaceMonitorsInner {
	return v.value
}

func (v *NullableSingleWorkspace200ResponseWorkspaceMonitorsInner) Set(val *SingleWorkspace200ResponseWorkspaceMonitorsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSingleWorkspace200ResponseWorkspaceMonitorsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSingleWorkspace200ResponseWorkspaceMonitorsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSingleWorkspace200ResponseWorkspaceMonitorsInner(val *SingleWorkspace200ResponseWorkspaceMonitorsInner) *NullableSingleWorkspace200ResponseWorkspaceMonitorsInner {
	return &NullableSingleWorkspace200ResponseWorkspaceMonitorsInner{value: val, isSet: true}
}

func (v NullableSingleWorkspace200ResponseWorkspaceMonitorsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSingleWorkspace200ResponseWorkspaceMonitorsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
