...
// checks if the CreateEnvironmentRequestEnvironmentValuesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateEnvironmentRequestEnvironmentValuesInner{}
...
// NewCreateEnvironmentRequestEnvironmentValuesInner instantiates a new CreateEnvironmentRequestEnvironmentValuesInner object
...
func NewCreateEnvironmentRequestEnvironmentValuesInner() *CreateEnvironmentRequestEnvironmentValuesInner {
	this := CreateEnvironmentRequestEnvironmentValuesInner{}
	return &this
}

// NewCreateEnvironmentRequestEnvironmentValuesInnerWithDefaults instantiates a new CreateEnvironmentRequestEnvironmentValuesInner object
...
func (o *CreateEnvironmentRequestEnvironmentValuesInner) SetEnabled(v bool) {
	o.Enabled = &v
}
...
func (o *CreateEnvironmentRequestEnvironmentValuesInner) SetKey(v string) {
	o.Key = &v
}
...
func (o *CreateEnvironmentRequestEnvironmentValuesInner) SetType(v string) {
	o.Type = &v
}
...
func (o *CreateEnvironmentRequestEnvironmentValuesInner) SetValue(v string) {
	o.Value = &v
}

func (o CreateEnvironmentRequestEnvironmentValuesInner) MarshalJSON() ([]byte, error) {
...
type NullableCreateEnvironmentRequestEnvironmentValuesInner struct {
	value *CreateEnvironmentRequestEnvironmentValuesInner
	isSet bool
}

func (v NullableCreateEnvironmentRequestEnvironmentValuesInner) Get() *CreateEnvironmentRequestEnvironmentValuesInner {
	return v.value
}

func (v *NullableCreateEnvironmentRequestEnvironmentValuesInner) Set(val *CreateEnvironmentRequestEnvironmentValuesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateEnvironmentRequestEnvironmentValuesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateEnvironmentRequestEnvironmentValuesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateEnvironmentRequestEnvironmentValuesInner(val *CreateEnvironmentRequestEnvironmentValuesInner) *NullableCreateEnvironmentRequestEnvironmentValuesInner {
	return &NullableCreateEnvironmentRequestEnvironmentValuesInner{value: val, isSet: true}
}

func (v NullableCreateEnvironmentRequestEnvironmentValuesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateEnvironmentRequestEnvironmentValuesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
