...
// checks if the AllEnvironments401ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllEnvironments401ResponseError{}
...
// NewAllEnvironments401ResponseError instantiates a new AllEnvironments401ResponseError object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAllEnvironments401ResponseError() *AllEnvironments401ResponseError {
	this := AllEnvironments401ResponseError{}
	return &this
}

// NewAllEnvironments401ResponseErrorWithDefaults instantiates a new AllEnvironments401ResponseError object
...
func (o *AllEnvironments401ResponseError) GetName() string {
...
func (o *AllEnvironments401ResponseError) HasName() bool {
	if o != nil && !isNil(o.Name) {
		return true
	}
...
func (o *AllEnvironments401ResponseError) SetName(v string) {
	o.Name = &v
}
...
type NullableAllEnvironments401ResponseError struct {
	value *AllEnvironments401ResponseError
	isSet bool
}

func (v NullableAllEnvironments401ResponseError) Get() *AllEnvironments401ResponseError {
	return v.value
}

func (v *NullableAllEnvironments401ResponseError) Set(val *AllEnvironments401ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableAllEnvironments401ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableAllEnvironments401ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllEnvironments401ResponseError(val *AllEnvironments401ResponseError) *NullableAllEnvironments401ResponseError {
	return &NullableAllEnvironments401ResponseError{value: val, isSet: true}
}
