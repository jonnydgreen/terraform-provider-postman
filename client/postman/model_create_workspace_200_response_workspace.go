...
// checks if the CreateWorkspace200ResponseWorkspace type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateWorkspace200ResponseWorkspace{}
...
// NewCreateWorkspace200ResponseWorkspace instantiates a new CreateWorkspace200ResponseWorkspace object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCreateWorkspace200ResponseWorkspace() *CreateWorkspace200ResponseWorkspace {
	this := CreateWorkspace200ResponseWorkspace{}
	return &this
}

// NewCreateWorkspace200ResponseWorkspaceWithDefaults instantiates a new CreateWorkspace200ResponseWorkspace object
...
func (o *CreateWorkspace200ResponseWorkspace) SetId(v string) {
	o.Id = &v
}
...
func (o *CreateWorkspace200ResponseWorkspace) SetName(v string) {
	o.Name = &v
}
...
type NullableCreateWorkspace200ResponseWorkspace struct {
	value *CreateWorkspace200ResponseWorkspace
	isSet bool
}

func (v NullableCreateWorkspace200ResponseWorkspace) Get() *CreateWorkspace200ResponseWorkspace {
	return v.value
}

func (v *NullableCreateWorkspace200ResponseWorkspace) Set(val *CreateWorkspace200ResponseWorkspace) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateWorkspace200ResponseWorkspace) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateWorkspace200ResponseWorkspace) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateWorkspace200ResponseWorkspace(val *CreateWorkspace200ResponseWorkspace) *NullableCreateWorkspace200ResponseWorkspace {
	return &NullableCreateWorkspace200ResponseWorkspace{value: val, isSet: true}
}

func (v NullableCreateWorkspace200ResponseWorkspace) MarshalJSON() ([]byte, error) {
