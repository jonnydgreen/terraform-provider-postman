...
// checks if the CreateEnvironment200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateEnvironment200Response{}
...
// NewCreateEnvironment200Response instantiates a new CreateEnvironment200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCreateEnvironment200Response() *CreateEnvironment200Response {
	this := CreateEnvironment200Response{}
	return &this
}

// NewCreateEnvironment200ResponseWithDefaults instantiates a new CreateEnvironment200Response object
...
func (o *CreateEnvironment200Response) GetEnvironment() CreateEnvironment200ResponseEnvironment {
	if o == nil || isNil(o.Environment) {
		var ret CreateEnvironment200ResponseEnvironment
		return ret
	}
...
func (o *CreateEnvironment200Response) GetEnvironmentOk() (*CreateEnvironment200ResponseEnvironment, bool) {
	if o == nil || isNil(o.Environment) {
		return nil, false
	}
...
func (o *CreateEnvironment200Response) SetEnvironment(v CreateEnvironment200ResponseEnvironment) {
	o.Environment = &v
}
...
type NullableCreateEnvironment200Response struct {
	value *CreateEnvironment200Response
	isSet bool
}

func (v NullableCreateEnvironment200Response) Get() *CreateEnvironment200Response {
	return v.value
}

func (v *NullableCreateEnvironment200Response) Set(val *CreateEnvironment200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateEnvironment200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateEnvironment200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateEnvironment200Response(val *CreateEnvironment200Response) *NullableCreateEnvironment200Response {
	return &NullableCreateEnvironment200Response{value: val, isSet: true}
}
