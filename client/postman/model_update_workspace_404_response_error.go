...
// checks if the UpdateWorkspace404ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateWorkspace404ResponseError{}
...
// NewUpdateWorkspace404ResponseErrorWithDefaults instantiates a new UpdateWorkspace404ResponseError object
...
type NullableUpdateWorkspace404ResponseError struct {
	value *UpdateWorkspace404ResponseError
	isSet bool
}

func (v NullableUpdateWorkspace404ResponseError) Get() *UpdateWorkspace404ResponseError {
	return v.value
}

func (v *NullableUpdateWorkspace404ResponseError) Set(val *UpdateWorkspace404ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateWorkspace404ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateWorkspace404ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateWorkspace404ResponseError(val *UpdateWorkspace404ResponseError) *NullableUpdateWorkspace404ResponseError {
	return &NullableUpdateWorkspace404ResponseError{value: val, isSet: true}
}
