...
// checks if the SingleWorkspace200ResponseWorkspaceMocksInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SingleWorkspace200ResponseWorkspaceMocksInner{}
...
// NewSingleWorkspace200ResponseWorkspaceMocksInner instantiates a new SingleWorkspace200ResponseWorkspaceMocksInner object
...
func NewSingleWorkspace200ResponseWorkspaceMocksInner() *SingleWorkspace200ResponseWorkspaceMocksInner {
	this := SingleWorkspace200ResponseWorkspaceMocksInner{}
	return &this
}

// NewSingleWorkspace200ResponseWorkspaceMocksInnerWithDefaults instantiates a new SingleWorkspace200ResponseWorkspaceMocksInner object
...
func (o *SingleWorkspace200ResponseWorkspaceMocksInner) SetId(v string) {
	o.Id = &v
}
...
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceMocksInner) SetName(v string) {
	o.Name = &v
}
...
// Deprecated
func (o *SingleWorkspace200ResponseWorkspaceMocksInner) SetUid(v string) {
	o.Uid = &v
}

func (o SingleWorkspace200ResponseWorkspaceMocksInner) MarshalJSON() ([]byte, error) {
...
type NullableSingleWorkspace200ResponseWorkspaceMocksInner struct {
	value *SingleWorkspace200ResponseWorkspaceMocksInner
	isSet bool
}

func (v NullableSingleWorkspace200ResponseWorkspaceMocksInner) Get() *SingleWorkspace200ResponseWorkspaceMocksInner {
	return v.value
}

func (v *NullableSingleWorkspace200ResponseWorkspaceMocksInner) Set(val *SingleWorkspace200ResponseWorkspaceMocksInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSingleWorkspace200ResponseWorkspaceMocksInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSingleWorkspace200ResponseWorkspaceMocksInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSingleWorkspace200ResponseWorkspaceMocksInner(val *SingleWorkspace200ResponseWorkspaceMocksInner) *NullableSingleWorkspace200ResponseWorkspaceMocksInner {
	return &NullableSingleWorkspace200ResponseWorkspaceMocksInner{value: val, isSet: true}
}

func (v NullableSingleWorkspace200ResponseWorkspaceMocksInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSingleWorkspace200ResponseWorkspaceMocksInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
