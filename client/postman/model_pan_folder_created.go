...
// checks if the PANFolderCreated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PANFolderCreated{}
...
// NewPANFolderCreatedWithDefaults instantiates a new PANFolderCreated object
...
type NullablePANFolderCreated struct {
	value *PANFolderCreated
	isSet bool
}

func (v NullablePANFolderCreated) Get() *PANFolderCreated {
	return v.value
}

func (v *NullablePANFolderCreated) Set(val *PANFolderCreated) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePANFolderCreated(val *PANFolderCreated) *NullablePANFolderCreated {
	return &NullablePANFolderCreated{value: val, isSet: true}
}
