...
// checks if the CreatePANWorkspace type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePANWorkspace{}
...
// NewCreatePANWorkspace instantiates a new CreatePANWorkspace object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCreatePANWorkspace() *CreatePANWorkspace {
	this := CreatePANWorkspace{}
	return &this
}

// NewCreatePANWorkspaceWithDefaults instantiates a new CreatePANWorkspace object
...
func (o *CreatePANWorkspace) GetWorkspace() CreatePANWorkspaceWorkspace {
	if o == nil || IsNil(o.Workspace) {
		var ret CreatePANWorkspaceWorkspace
		return ret
	}
	return *o.Workspace
}
...
func (o *CreatePANWorkspace) SetWorkspace(v CreatePANWorkspaceWorkspace) {
	o.Workspace = &v
}
...
type NullableCreatePANWorkspace struct {
	value *CreatePANWorkspace
	isSet bool
}

func (v NullableCreatePANWorkspace) Get() *CreatePANWorkspace {
	return v.value
}

func (v *NullableCreatePANWorkspace) Set(val *CreatePANWorkspace) {
	v.value = val
	v.isSet = true
}
...
func NewNullableCreatePANWorkspace(val *CreatePANWorkspace) *NullableCreatePANWorkspace {
	return &NullableCreatePANWorkspace{value: val, isSet: true}
}
