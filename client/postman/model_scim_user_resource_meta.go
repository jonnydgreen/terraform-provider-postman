...
// checks if the ScimUserResourceMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScimUserResourceMeta{}
...
// NewScimUserResourceMetaWithDefaults instantiates a new ScimUserResourceMeta object
...
type NullableScimUserResourceMeta struct {
	value *ScimUserResourceMeta
	isSet bool
}

func (v NullableScimUserResourceMeta) Get() *ScimUserResourceMeta {
	return v.value
}

func (v *NullableScimUserResourceMeta) Set(val *ScimUserResourceMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableScimUserResourceMeta) IsSet() bool {
	return v.isSet
}
...
func NewNullableScimUserResourceMeta(val *ScimUserResourceMeta) *NullableScimUserResourceMeta {
	return &NullableScimUserResourceMeta{value: val, isSet: true}
}
